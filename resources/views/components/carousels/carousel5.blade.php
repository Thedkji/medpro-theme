...
<div class="container-item2 carousel5 relative">
    ...
    <div class="content-container swiper m-content">
        <div class="swiper-wrapper" id="swiper-wrapper-d4696beef0e0f8fe" aria-live="polite">
                                ...
                                <span>
                                    ...
                                    <span>
                                        ...
                                        <svg stroke="currentColor" fill="currentColor" stroke-width="0"
                                            viewBox="0 0 1024 1024" color="#FFB54A" height="16" width="16"
            ...
            <div class="swiper-slide" role="group" aria-label="3 / 5" style="width: 275.25px; margin-right: 20px;">
                <div class="content-item">
                    <a href="###">
                        <div class="img">
                            <img src="./assets/imgs/0478ff2f-00fd-478a-a52f-49396cf6ac75-bs_traaoan_thaaa_oanh.webp"
    ...
    <div class="swiper-button-prev swiper-button-disabled" tabindex="-1" role="button" aria-label="Previous slide"
        aria-controls="swiper-wrapper-d4696beef0e0f8fe" aria-disabled="true">
    ...
    <div class="swiper-button-next" tabindex="0" role="button" aria-label="Next slide"
        aria-controls="swiper-wrapper-d4696beef0e0f8fe" aria-disabled="false">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" color="#003553"
    ...
    <div class="view-all">
        <a href="#">
            <button>
                ...
                <img src="./assets/imgs/direction-left.svg" alt="">
            </button>
        </a>
    </div>
</div>
