...
@section('contents')
    ...
    <div id="home">
        ...
        <div class="m-content"></div>
        @php
            $test = collect(range(1, 7))->map(function () {
                return (object) [
                    'img' => './assets/imgs/thanh-nien-logo.webp',
                    'title' => '123',
                    'content' => '123222',
                ];
            });
        @endphp
        <div class="">
            <x-carousels.carousel1 :titleC="'Được tin tưởng hợp tác và đồng hành'" :carousels1="$test" />
        </div>
